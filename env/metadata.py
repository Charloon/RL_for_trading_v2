...
class Metadata():
    ...
    - n_step_LTF = number of time steps to skip at the beginning of the lowest timeframe dataset for moving averages
    ...
    def __init__(self, market = "stock", render_mode = ['human'], account = Account(),
                ...
                mode = "training", n_step_LTF = 200, suffix = "", kwargs_reward = {}):
